          ...
          children: [
            Container(
              ...
              child: Row(children: [
                Container(
                    width:
                        ResponsiveWidth(context, 100, designScreenWidth: 1034),
                    height:
                        ResponsiveHeight(context, 100, designScreenHeight: 613),
            ...
            Container(
                width: ResponsiveWidth(context, double.infinity,
                    designScreenWidth: 1034),
                height: ResponsiveHeight(context, 60, designScreenHeight: 613),
                alignment: Alignment.centerLeft,
                child: Container(
                    width:
                        ResponsiveWidth(context, 600, designScreenWidth: 1034),
                    height:
                        ResponsiveHeight(context, 50, designScreenHeight: 613),
                    decoration: BoxDecoration(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.download_for_offline_rounded, color: Colors.black),
                  SizedBox(width: 10),
